                    ...
                    <div class="col-xl-12">
                        <div class="card event-bx">
                            ...
                            <div class="card-body dz-scroll loadmore-content pt-0" id="EventListContent">
                                <div class="media event-list pb-3 border-bottom mb-3">
                                    ...
                                    <div class="media-body">
                                        <h4 class="fs-18 mb-sm-0 mb-2"><a href="javascript:void(0);" class="text-black">Konser Dewa 19 Di Gor Pasuruan</a></h4>
                                        <span class="fs-14 d-block mb-sm-2 mb-2 text-secondary">Pasuruan, Indonesia</span>
                            ...
                            <div class="card-footer text-center pt-0 border-0">
                                <a href="javascript:void(0);" class="btn btn-secondary btn-lg  text-white dz-load-more" id="EventList" rel="ajax/event-list.html">Load More</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-footer pt-0 border-0">
                                <a href="javascript:void(0);" class="btn btn-secondary btn-block text-white dz-load-more" id="UpcomingEvent" rel="ajax/upcoming-event.html">Load More</a>
                            </div>
                        </div>
                    </div>
                </div>
